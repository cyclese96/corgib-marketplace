...
export default function CustomMenu({ sortFn }) {
    ...
    <div>
      ...
      >
        <StyledMenuItem onClick={() => selectMenu("p1")}>
          <ListItemText>
            <span className={classes.menuText}>Highest Price</span>
          </ListItemText>
        </StyledMenuItem>
        <StyledMenuItem onClick={() => selectMenu("p2")}>
          <ListItemText>
            <span className={classes.menuText}>Low Price</span>
          </ListItemText>
        </StyledMenuItem>

        <StyledMenuItem onClick={() => selectMenu("l1")}>
          <ListItemText>
            <span className={classes.menuText}>Cheapest</span>
          </ListItemText>
        </StyledMenuItem>
        <StyledMenuItem onClick={() => selectMenu("l2")}>
          <ListItemText>
            <span className={classes.menuText}>Most Liked</span>
          </ListItemText>
        </StyledMenuItem>
      </StyledMenu>
    </div>
